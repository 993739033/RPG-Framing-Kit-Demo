...
public class Saveable : MonoBehaviour
{
    ...
    private void OnDrawGizmosSelected()
    {
        ...
        if (identificationData != identification)
        {
            if (saveIdentification.UseConstant)
            {
                ...
                {
                    Debug.Log("Saveable Component: A new save " +
                              "identification has been made for duplicated object");
    ...
    private void Awake()
    {
        ...
        {
            saveableComponentDictionary
                .Add(saveableComponents[i].identifier.Value,
                saveableComponents[i].monoBehaviour as ISaveable);
        }
