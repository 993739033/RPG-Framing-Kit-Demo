...
public class InputSystem : GameSystem
{
    ...
    private void OnGUI()
    {
        GUILayout.BeginArea(new Rect(50, 50, 250, 120));
        Vector3 mousePosition = Input.mousePosition;
        GUILayout.Label("mousePoint:"+mousePosition.x+":"+mousePosition.y);
        Vector3 mouseWorldPoint = camera.ScreenToWorldPoint(mousePosition);
        GUILayout.Label("worldPoint:" + mouseWorldPoint.x + ":" + mouseWorldPoint.y + ":" + mouseWorldPoint.z);
        GUILayout.EndArea();
//        Debug.Log(mousePosition+":"+mouseWorldPoint);
    }
